...
namespace InvoicesManagementSystem.Controllers
{
    ...
    public class Invoice_DetailController : ControllerBase
    {
        ...
        {
            if (id != invoice_Detail.InvoiceID)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Invoice_Detail>> PostInvoice_Detail(Invoice_Detail invoice_Detail)
        {
          if (_context.Invoice_Details == null)
          {
            ...
            {
                if (Invoice_DetailExists(invoice_Detail.InvoiceID))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetInvoice_Detail", new { id = invoice_Detail.InvoiceID }, invoice_Detail);
        }
        ...
        {
            return (_context.Invoice_Details?.Any(e => e.InvoiceID == id)).GetValueOrDefault();
        }
    }
}
